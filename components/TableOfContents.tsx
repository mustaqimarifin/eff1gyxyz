import cn from 'clsx'
import { Block, BlockMap, type BlockType, type ExtendedRecordMap, type PageBlock, type RecordMap, TableOfContentsBlock } from 'notion-types'
...
export const TableOfContents: React.FC<TOC> = ({ blockMap, className, style }) => {
